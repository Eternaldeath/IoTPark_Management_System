...
<head>
    ...
    <title>所有订单详情</title>
    <meta name="description" content="所有订单详情">
    <meta name="keywords" content="所有订单详情">
                ...
                <div class="box-body">
                    ...
                    <div class="table-box">
                        ...
                        <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <tbody>
                            <c:forEach items="${allOrder}" var="all">
                                <tr>
                                    <td>${all.id}</td>
                                    <td>${all.vipId}</td>
                                    <td>${all.startTime}</td>
                                    <td>${all.scheduledTime}</td>
                                    <td>
                                        <c:if test="${all.orderValid==1}">进行中</c:if>
                                        <c:if test="${all.orderValid==0}">已结束</c:if>
                                    </td>
                                    <td>${all.parkNum} 号停车场</td>
                                    <td>${all.parkLotNum} 号车位</td>
                                    <td>￥${all.orderFee}</td>
                                </tr>
                            </c:forEach>
                            </tbody>
