...
<head>
    ...
    <title>当前订单详情</title>
    <meta name="description" content="当前订单详情">
    <meta name="keywords" content="当前订单详情">
                            ...
                            <c:forEach items="${curOrder}" var="cur">
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button type="button" class="btn btn-danger" onclick='location.href="deleteOrder?vipId=${cur.vipId}"'>删除</button>
                                        <br/>
<%--                                        <button type="button" class="btn btn-default" onclick='location.href="changeOrder?vipId=${cur.vipId}"'>修改</button>--%>
                                     </td>
                                </tr>
                            </c:forEach>
                            </tbody>
